...
export default async function BlogDetail({ params }: Props) {
  ...
  const readTime = getReadTime(blog.description, blog.points)
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[900px] px-6 py-14 sm:py-20">
        ...
        <Link
          href="/blogs"
          className="group mb-10 inline-flex items-center gap-2 [font-family:var(--font-space-mono)] text-[13px] text-[#8A7C6C] transition-colors hover:text-[#A85B3E]"
        >
        ...
        <div className="[font-family:var(--font-source-serif)] text-[17px] leading-[1.8] text-[#3D342B] sm:text-[18.5px]">
          <ReactMarkdown
            ...
            components={{
              h1: ({ node, ...props }) => (
                <h1
                  className="mb-4 mt-8 [font-family:var(--font-fraunces)] text-3xl font-semibold text-[#231A12]"
                  {...props}
                />
              ),
              h2: ({ node, ...props }) => (
                <h2
                  className="mb-4 mt-8 [font-family:var(--font-fraunces)] text-2xl font-semibold text-[#231A12]"
                  {...props}
                />
              ),
              h3: ({ node, ...props }) => (
                <h3
                  className="mb-3 mt-6 [font-family:var(--font-fraunces)] text-xl font-semibold text-[#231A12]"
                  {...props}
                />
              ),
              p: ({ node, ...props }) => {
              ...
              code: ({ node, ...props }) => (
                <code
                  className="rounded bg-[#F3E7D6] px-2 py-1 text-sm [font-family:var(--font-space-mono)]"
                  {...props}
                />
              ),
              pre: ({ node, ...props }) => (
                <pre
                  className="mb-6 overflow-x-auto rounded-lg bg-[#F3E7D6] p-4"
                  {...props}
                />
              ),
