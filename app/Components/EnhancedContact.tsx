...
<Link
  ...
  className="flex items-center gap-2 p-2 bg-muted rounded-lg transition hover:bg-accent/10"
...
<Link
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="flex items-center gap-4 p-4 bg-muted rounded-lg transition hover:bg-accent/10"
